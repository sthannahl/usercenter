...
import (
	...
	"sthannahl/usercenter/common/crypto"
...
func NewManager() *Manager {
	return &Manager{
		...
		validateURI: manage.DefaultValidateURI,
	}
}
...
func (m *Manager) GenerateAccessToken(gt oauth2.GrantType, tgr *oauth2.TokenGenerateRequest) (oauth2.TokenInfo, error) {
	...
	if err != nil {
		return nil, err
	} else if !crypto.CompareHashAndPassword(tgr.ClientSecret, cli.GetSecret()) {
